...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/roadworkflow.git
cd roadworkflow

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/roadworkflow.git
